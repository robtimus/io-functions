 ...
 * This is the {@link IOException} throwing equivalent of {@link LongToIntFunction}.
 */
@FunctionalInterface
public interface LongToIntIOFunction {
     ...
     */
    int applyAsInt(long value) throws IOException;
     ...
     */
    static LongToIntFunction unchecked(LongToIntIOFunction function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static LongToIntIOFunction checked(LongToIntFunction function) {
        Objects.requireNonNull(function);
        return value -> {
            try {
                return function.applyAsInt(value);
