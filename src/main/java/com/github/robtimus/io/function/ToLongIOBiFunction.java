 ...
 * This is the {@link IOException} throwing equivalent of {@link ToLongBiFunction}.
 *
...
public interface ToLongIOBiFunction<T, U> {
     ...
     */
    static <T, U> ToLongBiFunction<T, U> unchecked(ToLongIOBiFunction<? super T, ? super U> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T, U> ToLongIOBiFunction<T, U> checked(ToLongBiFunction<? super T, ? super U> function) {
        Objects.requireNonNull(function);
        return (t, u) -> {
            try {
                return function.applyAsLong(t, u);
