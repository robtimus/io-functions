 ...
 * This is the {@link IOException} throwing equivalent of {@link DoubleToLongFunction}.
 */
@FunctionalInterface
public interface DoubleToLongIOFunction {
     ...
     */
    static DoubleToLongFunction unchecked(DoubleToLongIOFunction function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static DoubleToLongIOFunction checked(DoubleToLongFunction function) {
        Objects.requireNonNull(function);
        return value -> {
            try {
                return function.applyAsLong(value);
