 ...
 * This is the {@link IOException} throwing equivalent of {@link DoubleUnaryOperator}.
 */
@FunctionalInterface
public interface DoubleUnaryIOOperator {
     ...
     * @see #andThen(DoubleUnaryIOOperator)
     */
    default DoubleUnaryIOOperator compose(DoubleUnaryIOOperator before) {
     ...
     * @see #compose(DoubleUnaryIOOperator)
     */
    default DoubleUnaryIOOperator andThen(DoubleUnaryIOOperator after) {
     ...
     */
    static DoubleUnaryOperator unchecked(DoubleUnaryIOOperator operator) {
     ...
     * @throws NullPointerException If {@code operator} is {@code null}.
     */
    static DoubleUnaryIOOperator checked(DoubleUnaryOperator operator) {
        Objects.requireNonNull(operator);
        return operand -> {
            try {
                return operator.applyAsDouble(operand);
