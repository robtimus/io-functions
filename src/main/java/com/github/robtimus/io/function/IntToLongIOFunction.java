 ...
 * This is the {@link IOException} throwing equivalent of {@link IntToLongFunction}.
 */
@FunctionalInterface
public interface IntToLongIOFunction {
     ...
     */
    long applyAsLong(int value) throws IOException;
     ...
     */
    static IntToLongFunction unchecked(IntToLongIOFunction function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static IntToLongIOFunction checked(IntToLongFunction function) {
        Objects.requireNonNull(function);
        return value -> {
            try {
                return function.applyAsLong(value);
