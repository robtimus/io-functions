 ...
 * This is the {@link IOException} throwing equivalent of {@link ToLongFunction}.
 *
...
public interface ToLongIOFunction<T> {
     ...
     */
    static <T> ToLongFunction<T> unchecked(ToLongIOFunction<? super T> function) {
