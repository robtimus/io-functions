 ...
 * This is the {@link IOException} throwing equivalent of {@link DoubleFunction}.
 *
 * @param <R> The type of the result of the function.
 */
@FunctionalInterface
public interface DoubleIOFunction<R> {
     ...
     */
    static <R> DoubleFunction<R> unchecked(DoubleIOFunction<? extends R> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <R> DoubleIOFunction<R> checked(DoubleFunction<? extends R> function) {
        Objects.requireNonNull(function);
        return value -> {
            try {
                return function.apply(value);
