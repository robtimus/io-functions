 ...
 * This is the {@link IOException} throwing equivalent of {@link IntPredicate}.
 */
@FunctionalInterface
public interface IntIOPredicate {
     ...
     */
    default IntIOPredicate and(IntIOPredicate other) {
     ...
     * @throws NullPointerException If {@code other} is {@code null}.
     */
    default IntIOPredicate or(IntIOPredicate other) {
        Objects.requireNonNull(other);
        return value -> test(value) || other.test(value);
    }
     ...
     */
    static IntPredicate unchecked(IntIOPredicate predicate) {
     ...
     */
    static IntIOPredicate checked(IntPredicate predicate) {
        Objects.requireNonNull(predicate);
        return value -> {
            try {
                return predicate.test(value);
