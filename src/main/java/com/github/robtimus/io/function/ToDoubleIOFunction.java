 ...
 * This is the {@link IOException} throwing equivalent of {@link ToDoubleFunction}.
 *
...
public interface ToDoubleIOFunction<T> {
     ...
     */
    static <T> ToDoubleFunction<T> unchecked(ToDoubleIOFunction<? super T> function) {
     ...
     * @throws NullPointerException If {@code function} is {@code null}.
     */
    static <T> ToDoubleIOFunction<T> checked(ToDoubleFunction<? super T> function) {
        Objects.requireNonNull(function);
        return value -> {
            try {
                return function.applyAsDouble(value);
