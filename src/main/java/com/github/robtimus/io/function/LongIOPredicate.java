 ...
 * This is the {@link IOException} throwing equivalent of {@link LongPredicate}.
 */
@FunctionalInterface
public interface LongIOPredicate {
     ...
     */
    default LongIOPredicate and(LongIOPredicate other) {
     ...
     * @throws NullPointerException If {@code other} is {@code null}.
     */
    default LongIOPredicate or(LongIOPredicate other) {
        Objects.requireNonNull(other);
        return value -> test(value) || other.test(value);
    }
     ...
     */
    static LongPredicate unchecked(LongIOPredicate predicate) {
     ...
     */
    static LongIOPredicate checked(LongPredicate predicate) {
        Objects.requireNonNull(predicate);
        return value -> {
            try {
                return predicate.test(value);
