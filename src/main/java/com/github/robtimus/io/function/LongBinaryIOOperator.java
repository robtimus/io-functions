 ...
 * This is the {@link IOException} throwing equivalent of {@link LongBinaryOperator}.
 */
@FunctionalInterface
public interface LongBinaryIOOperator {
     ...
     */
    static LongBinaryOperator unchecked(LongBinaryIOOperator operator) {
